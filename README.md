...
L'application reproduit les mêmes fonctionnalités que la version PowerShell avec :
- Une interface moderne et responsive
- Un effet Mica natif sur Windows 11
- Un redimensionnement fluide des contrôles
