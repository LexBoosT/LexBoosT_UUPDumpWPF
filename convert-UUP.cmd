...
:: Copy autounattend.xml from Unattend folder to ISOFOLDER
if exist "Unattend\autounattend.xml" (
copy /y "Unattend\autounattend.xml" "ISOFOLDER\autounattend.xml" %_Nul3%
if exist "ISOFOLDER\autounattend.xml" (
call :dk_color1 %Green% "=== autounattend.xml copied successfully to ISOFOLDER" 4
) else (
call :dk_color1 %Red% "=== Failed to copy autounattend.xml to ISOFOLDER" 4
)
) else (
call :dk_color1 %Yellow% "=== Unattend\autounattend.xml not found, skipping copy" 4
)
